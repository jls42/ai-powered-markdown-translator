# Traductor de Markdown impulsado por IA con OpenAI, Mistral AI y Claude d'Anthropic

Este proyecto es un script avanzado de Python que utiliza las API de OpenAI, Mistral AI o Claude d'Anthropic para traducir archivos Markdown de un idioma fuente a un idioma objetivo. Está diseñado para ser flexible y fácil de usar, ofreciendo opciones adicionales como agregar una nota de traducción, gestión mejorada de archivos de salida, detección de archivos existentes y soporte para múltiples idiomas y modelos de traducción.
...
- **Traducción impulsada por IA**: Utilice las últimas tecnologías de IA para la traducción de sus documentos con OpenAI, Mistral AI o Claude d'Anthropic.
- **Soporte multilingüe**: Traduce tus documentos a varios idiomas con soporte para diferentes modelos de lenguaje.
...
- **Detección de archivos existentes mejorada**: Busque archivos que correspondan al nombre base del archivo original y al idioma objetivo.
...
- Una clave de API válida para OpenAI, Mistral AI o Claude d'Anthropic.
...
- `--source_lang`: Idioma fuente de los documentos. Importante especialmente para agregar notas de traducción.
...
- `--use_claude`: Usar la API de Claude d'Anthropic para la traducción.
...
Este proyecto está bajo la licencia GNU GENERAL PUBLIC LICENSE Version 3, 29 June 2007. Ver el archivo [LICENSE](LICENSE) para más detalles.

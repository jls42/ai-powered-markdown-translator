...
- **1.6** Novità :
    ...
    - Traduzione di un singolo file (`--file`) senza scansionare una cartella
    ...
    - Supporto per modelli non elencati con limite di token predefinita (128k)
...
- **1.5** Miglioramenti :
    ...
    - **Refactoring del codice :**
        ...
        - Miglioramento della segmentazione dei testi e della gestione dei blocchi di codice per preservare il formato originale durante la traduzione.

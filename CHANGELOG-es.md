...
- **1.6** Novedades:
    ...
    - Opción `--include_model` para conservar el viejo formato con el nombre del modelo
...
- **1.5** Mejoras:
    ...
    - **Optimización de los prompts de traducción:**
        - Los prompts para las traducciones directas y las notas de traducción se han enriquecido para una mayor claridad y eficiencia, incluyendo instrucciones detalladas sobre la preservación de los metadatos y de elementos de formateo específicos.
    - **Refactorización del código:**
        ...
        - Mejora de la segmentación de textos y gestión de los bloques de código para preservar el formateo original durante la traducción.

...
- **1.5** Mejoras:
    ...
    - **Optimización de los prompts de traducción:**
        - Los prompts para las traducciones directas y las notas de traducción han sido enriquecidos para una mayor claridad y eficiencia, incluyendo instrucciones detalladas sobre la preservación de los metadatos y los elementos de formato específicos.
